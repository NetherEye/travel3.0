				...
				<div class="filter" @mouseenter='isFilter=true' @click.stop='isFilter=true'>
					...
					<el-form :inline="true" :model="filter" class="demo-form-inline">
						<el-form-item label="景区名称">
							<el-input class="mar" style="width: 200px;" v-model="filter.scenicName" width="80px" clearable placeholder="景区名称"></el-input>
						</el-form-item>
						...
						<el-form-item label="景区融合类型">
							<el-select v-model="filter.fusionype" clearable placeholder="全部">
	...
	methods: {
		...
		getData() {
			let par = {
				...
				fusionType: this.filter.fusionype,
			}
