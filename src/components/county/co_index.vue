	...
	<div class="public">
		<div class="main loading">
			<div class="left">
				<div class="top">
					<div class="data_item">
						<p class="data_p">2017-2019年3年计划数： <span class="data">{{tableData.totalNumber}}人</span></p>
						<div class="line" style="height: 1px;background:rgba(238,238,238,1);cursor:pointer;"></div>
						<p class="data_p">2017年计划数： <span class="data">{{tableData.firstNumber}}人</span></p>
						<div class="line" style="height: 1px;background:rgba(238,238,238,1);"></div>
						<p class="data_p">2018年计划数： <span class="data">{{tableData.secondNumber}}人</span></p>
						<div class="line" style="height: 1px;background:rgba(238,238,238,1);"></div>
						<p class="data_p">2019年计划数： <span class="data">{{tableData.thirdNumber}}人</span></p>
					</div>
				</div>
				<div class="line" style="height: 1px;background:rgba(238,238,238,1);"></div>
				<div class="bottom">
...
export default {
	...
	methods: {
		// 导出
		exports() {
			fetch.export(allApi.exportCounty, '', res => {
				if (res.code === 200) {
		...
		//
		inports() {
			fetch.export(index.helpPoor + '/country', '', res => {
				if (res.code === 200) {
					window.location = res.href
				}
