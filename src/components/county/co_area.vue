				...
				<div class="filter" @mouseenter='isFilter=true' @click.stop='isFilter=true'>
					<el-form :inline="true" :model="filter" class="demo-form-inline">
						<el-form-item label="申请类型">
							<el-select v-model="filter.Application" placeholder="全部" clearable>
						...
						<el-form-item label="申请日期">
							<div class="block">
								<el-date-picker v-model="filter.time" type="date" value-format="yyyy-MM-dd" placeholder="选择日期">
								</el-date-picker>
							</div>
						</el-form-item>
					...
					<div class="filter_btn">
						...
						<div class="btn btn3" @click="application">填报申请</div>
					</div>
				</div>
				<div class="table">
	...
	methods: {
		...
		getData() {
			let par = {
				...
				applyType: this.filter.Application
			}
