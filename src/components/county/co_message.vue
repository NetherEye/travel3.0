			...
			<div class="right">
				<div class="top">
					<div class="news">
						...
						<div class="new_content">
							<div class="new_content_item" v-for="(item, i) in new2Arr" :key="i" @click="look2(item)">
								<span class="ellipsis">{{item.title}}</span>
								<span style="width: 200px;min-width: 200px;">{{item.publishTime}}</span>
							</div>
						</div>
						<div class="fenye">
							...
							<el-pagination :current-page.sync="currentPage2" @current-change="getData2" :pager-count="5" small :page-size="pageSize2" layout="prev, pager, next, jumper" :total="total2">
							</el-pagination>
						</div>
					</div>
				</div>
				<div class="bottom">
					<div class="news">
						...
						<div class="new_content">
							<div class="new_content_item" v-for="(item, i) in new3Arr" :key="i" @click="look1(item)">
								<span class="ellipsis">{{item.title}}</span>
								<span style="width: 200px;min-width: 200px;">{{item.publishTime}}</span>
							</div>
						</div>
...
export default{
	...
	methods: {
		...
		getData2() {
			...
			fetch.get(message.publisher, par2, res => {
				if (res.code === 200) {
					this.new2Arr = res.data;
