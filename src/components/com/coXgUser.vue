<template>
  <div class="public">
    <div class="box">
      ...
      <div class="content">
        <p class="color ft20">账号管理-修改账号</p>
        ...
        <div class="item" style="margin-bottom: 34px;">
          <div class="item_item1">
            ...
            <p>
              <el-select @change="selVa(userType)" disabled v-model="userType" placeholder="账户类型" style="width: 100%">
          ...
          <div class="item_item1">
            <div v-if="userType == 4">
              ...
              <div>
                ...
                <el-checkbox-group v-model="checkedCities" disabled @change="handleCheckedCitiesChange">
            ...
            <div v-else>
              ...
              <p>
                <el-select v-model="userTyp111e" disabled placeholder="管辖景区" style="width: 100%">
                  <el-option
                    disabled
                    v-for="item in fjqu"
                    :key="item.id"
          ...
          <div class="item_item1">
            ...
            <p>
              <el-input v-model="input43" disabled placeholder="请输入内容"></el-input>
            </p>
          </div>
          <div class="item_item1">
    ...
    methods :{
      getuserdata () {
        ...
        fetch.get(allApi.user+this.username,a,res=>{
          this.userType = res.data.orgLevel
          this.input5 = res.data.duty
          this.input7 = res.data.email
          this.input42 = res.data.nickName
          this.input43 = res.data.phone
          this.input4 = res.data.position
          this.input6 = res.data.qqNumber
          this.input41 = res.data.workCompany
          let a = res.data.belongDistrict
          let b = res.data.manageList
          let newArr = []
          for (var i in b) {
            newArr.push(b[i].id)
          }
          this.selVa(this.userType,a,newArr)
        })
      },
      setUp () {
        let a = {
