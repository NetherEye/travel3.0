						...
						<div class="filterBox" v-show="isFilter" style="padding: 36px 50px 46px 50px;">
							<el-form :inline="true" :model="filter" class="demo-form-inline">
								...
								<el-form-item label="九项工程">
									<el-select v-model="filter.belongType" placeholder="全部" clearable>
								...
								<el-form-item label="带动贫困人口增收方式">
									<el-select v-model="filter.incomeType" clearable placeholder="全部" style="width:205px">
								...
								<el-form-item label="填报员" label-width="76px">
									<el-select v-model="filter.username" clearable placeholder="全部" filterable>
								...
								<el-form-item label="景区名称" >
									<el-select v-model="filter.jingqu2" @change="jingqu2" style="width:300px" clearable placeholder="全部" filterable>
										<el-option v-for="item in countryOps" :key="item.id" :label="item.orgName" :value="item.id">
										</el-option>
									</el-select>
									<el-select v-model="filter.scenicId" clearable placeholder="全部" style="width:290px" filterable>
							...
							<div class="filter_btn">
								...
								<div class="btn btn2 btn-disabled">批量导出</div>
								<div class="btn btn3" @click="importE">批量导入贫困人口培训信息</div>
							</div>
						</div>
					</transition>
				</div>
				<div class="table">
					<el-table ref="table" :data="tableData" tooltip-effect="dark" style="width: 100%;" height="100%" header-cell-class-name="tableTou" cell-class-name="tableRow" @selection-change="handleSelectionChange">
