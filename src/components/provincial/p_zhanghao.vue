	...
	<div class="public" @click.stop='isFilter=false'>
		<div class="main">
			<div class="main_content">
                ...
                <el-form-item label="所属州市" >
                  <el-select v-model="filter.region" placeholder="全部" clearable style="width: 161px;">
                    <el-option v-for="item in city" :key="item.id"   :label="item.orgName" :value="item.id">
                    </el-option>
                  </el-select>
                </el-form-item>
                <el-form-item label="账号状态">
                  <el-select v-model="filter.status" placeholder="状态" clearable style="width: 161px;">
          ...
          <!--</transition>-->
				...
				<div class="table">
					<el-table ref="table" :data="tableData" tooltip-effect="dark" style="width: 99%;" height="100%" header-cell-class-name="tableTou" cell-class-name="tableRow" @selection-change="handleSelectionChange">
						<el-table-column type="index" label="序号"  align="center" width="100px" :index="indexMethod">
						</el-table-column>
						<el-table-column label="账号" align="center" show-overflow-tooltip>
							<template slot-scope="scope">{{ scope.row.username }}</template>
						</el-table-column>
						<el-table-column prop="belongDistrict" label="所属市州" align="center" show-overflow-tooltip>
						</el-table-column>
						...
						<el-table-column align="center" label="手机号码" show-overflow-tooltip>
							<template slot-scope="scope">
								<div class="textState2">{{scope.row.phone}}</div>
							</template>
						</el-table-column>
